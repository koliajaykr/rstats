...
# 🚀 PROLOGUE {background="image/prologue.png" background-position="right" background-size="42%"}

# ***ELPIS*** - in 2075![](image/chip.png)

# *ZACH* - the musician.

```{r }
knitr::include_graphics("image/zach.png")
```

# *ALICE* - the scientist.

```{r }
knitr::include_graphics("image/alice.png")
```

# *MILTON* - the talking cat.

```{r }
knitr::include_graphics("image/milton.png")
```
...
```{r}
#| fig.align: center
knitr::include_graphics("image/process.png")
```
...
"We want theories to be general and apply to the entire population rather than applying only to a specific case within that population."
:::
...
```{r}
#| fig.align: center
knitr::include_graphics("image/samperror.png")
```
:::
:::
...
```{r}
#| fig.align: center
knitr::include_graphics("image/answer.png")
```
...
#| fig-align: center
##| out-width: "64%"
knitr::include_graphics("image/aliceleft.png")
```
