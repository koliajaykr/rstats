...
The quantity of numbers in a class interval is known as the **class interval width.**
...
*"Alice was very satisfied with your relationship when she filled this questionnaire...Prof. looked little disappointed at the news."*
...
::: columns
::: {.column width="50%"}
-   Histogram plots the frequencies as bars rising up from the x-axis.![](image/histo_ras.png){width="700"}
:::
...
the frequent scores are clustered at the lower end and the tail points towards the higher or more positive scores![](image/skew.png){width="1500"}

## Negatively Skewed

the frequent scores are clustered at the higher end and the tail points towards the lower or more negative scores.![](image/skew.png){width="1500"}
...
tend to look flatter than normal![](image/kurtosis.png){width="1500"}
